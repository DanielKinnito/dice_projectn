"""
Django settings for dice_projectn project.
...
SECRET_KEY = 'django-insecure-v=@^_+n5@07p=tgg&!=96*kws41&%cjccd+xy#1r5-84rn4f3='
...
ROOT_URLCONF = 'dice_projectn.urls'
...
WSGI_APPLICATION = 'dice_projectn.wsgi.application'
